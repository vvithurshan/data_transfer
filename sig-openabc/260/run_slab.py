...
check_point_reporter = app.CheckpointReporter(file='slab_checkpoint.chk', reportInterval=1000, writeState=False)

simulation.reporters.append(dcd_reporter)
simulation.reporters.append(state_data_reporter)
simulation.reporters.append(check_point_reporter)
